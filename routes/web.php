...
Route::group(['as'=>'admin.', 'prefix' => 'admin', 'middleware' => 'auth' ], function(){
    ...
    Route::resource('fstock', 'FactoryStockController');

    Route::resource('stock', 'StockController');

    Route::resource('garden_stock', 'GardenStockController');
    Route::get('decreased/garden_stock', 'GardenStockController@used_g_stock')->name('decreases');
    Route::post('garden_stock/reduced', 'GardenStockController@reduced_g_stock')->name('reduced');

    Route::get('due', 'DueController@due')->name('due');
    Route::get('due/customer', 'DueController@customer_due')->name('customer_due');

    Route::post('pay/due/{customer_id}', 'DueController@pay_due')->name('pay_due');

    Route::get('profit', 'DashboardController@profit')->name('profit');
