            ...
            <div class="container-fluid">
                <div class="row">
                            ...
                            <form action="{{ route('admin.invoice.create') }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="discount" name="discount" placeholder="Enter discount %" min="0">
                                    </div>
                                        ...
                                        @foreach($cart_products as $product)
                                            <tr>
                                                ...
                                                <form action="{{ route('admin.cart.update', $product->rowId) }}" method="post">
                                                    ...
                                                    @method('PUT')
                                                    <td>
                                                        <input style="width: 60px;"  type="number" name="qty" class="form-control" value="{{ $product->qty }}" min="1">
                                                    </td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Available Products In Stock</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table style="table-layout: fixed;type : text;width : 100%;word-break: keep-all;" id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        @if($products->count()<1)
                                            <td class="text-center text-danger" colspan="7">Sorry no product available in Stock</td>
                                        @else
