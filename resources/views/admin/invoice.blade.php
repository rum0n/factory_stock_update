                    ...
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fa fa-globe"></i>M/s Akbor Enterprise
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td class="text-right">{{ $sub_total=Cart::subtotal() }}</td>
                                            </tr>
                                            <tr>
                                                <th>Discount ({{ $discount }}%)</th>
                                                <td class="text-right">{{ $discount_total=($sub_total*$discount)/100 }}</td>
                                            </tr>
                                            {{--<tr>--}}
                                                {{--<th>Tax </th>--}}
                                            ...
                                            <tr>
                                                <th>Total:</th>
                                                <td class="text-right">{{ Cart::total()-$discount_total }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <p class="text-info float-right mb-3">Payable Total : {{ Cart::total()-$discount_total }}</p>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="any" name="pay" class="form-control">
                            </div>
                        </div>
                    </div>
