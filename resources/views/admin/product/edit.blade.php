                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="garage" class="form-control">
                                                    ...
                                                    <option value="E" {{ $product->garage == "E" ? 'selected' : '' }}>Garage E</option>
                                                    <option value="F" {{ $product->garage == "F" ? 'selected' : '' }}>Garage F</option>
                                                    <option value="G" {{ $product->garage == "G" ? 'selected' : '' }}>Garage G</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label>Qty</label>
                                                    <input type="number" class="form-control" name="qty" value="{{ $product->qty }}" placeholder="Enter Product Qty" min="1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
