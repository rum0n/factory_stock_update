                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ round($sales->sum('total'),2) }} Taka</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $today_income }} Taka</span>
                                @php

                                    if($yesterday_income != 0)
                                    {
                                        $percentage = (($today_income - $yesterday_income)/ $yesterday_income)*100;
                                    } else {
                                        $percentage = 0;
                                    }
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">This Month's Income</span>
                                <span class="info-box-number">{{ $this_month_income }} Taka</span>
                                @php
                                    if($previous_month_income != 0)
                                    {
                                        $percentage = (($this_month_income - $previous_month_income)/ $previous_month_income)*100;
                                    } else {
                                        $percentage = 0;
                                    }
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">This Year's Income</span>
                                <span class="info-box-number">{{ $this_year_income }} Taka</span>
                                @php

                                    if($previous_year_income != 0)
                                    {
                                        $percentage = (($this_year_income - $previous_year_income)/ $previous_year_income)*100;
                                    } else {
                                        $percentage = 0;
                                    }
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text mt-3 pb-1">Total Income</span>
                                <span class="info-box-number mb-3">{{ $total_income }} Taka</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Today's Profits</span>
                                <span class="info-box-number">{{ round($today_profit,2) }} Taka</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Today's Profits</span>
                                <span class="info-box-number">{{ round($this_month_profit,2) }} Taka</span>

                                @php

                                if($previous_month_profit != 0)
                                {
                                $percentage = (($this_month_profit - $previous_month_profit)/ $previous_month_profit)*100;
                                } else {
                                $percentage = 0;
                                }
                                @endphp
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Today's Profits</span>
                                <span class="info-box-number">{{ round($this_year_profit,2) }} Taka</span>

                                @php

                                if($previous_year_profit != 0)
                                {
                                $percentage = (($this_year_profit - $previous_year_profit)/ $previous_year_profit)*100;
                                } else {
                                $percentage = 0;
                                }
                                @endphp
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text mt-3 pb-1">Total Expenses</span>
                                <span class="info-box-number mb-3">{{ round($total_profit,2) }} Taka</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
